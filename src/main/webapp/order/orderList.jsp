...
<body>
	...
	<main>
		<div id="body-content">
			<section id="section">
				<div id="container">
					<input id="btn1" type="button" value="예매/취소내역"
						style="background: darkgrey;"
						onclick="location.href='./MyPageMain.or'"> <input
						id="btn2" type="button" value="회원정보수정"
						onclick="location.href='./UserInfoCheck.me'">
	...
	<div id="myModal" class="modal">
		<div class="modal-content">
			...
			<input type="button" class="close" value="X"> <input
				type="button" id="cancelbtn" value="예매취소">
		</div>
	</div>
	<script>
		var choice = 0;
			...
			$('#cancelbtn').click(function() {
				if (confirm("정말 취소하시겠습니까??") == true) {
					...
					$.ajax({
						...
						success : function() {
							location.replace("MyPageMain.or");
						},
						error : function() {
							alert("에러");
						}
